...
?>
		...
		<p>Type a search term into the box below and get a JSON list of ten results from the <a href="http://developers.gettyimages.com/en/">Getty Images API.</a> Use the offset next to it to offset the first result you receive by that amount.</p>
		<form action="results2.php" method="get" name="mainform" onsubmit="return val()">
		...
		<p>You can also use the microservice directly by typing into your browser<br /> <em>https://uscabinetdb.rf.gd/test/results2.php?q={your_search_term}&offset={offset_amount}</em><br />Where <em>your_search_term</em> is a string and <em>offset_amount</em> is an integer.</p>
